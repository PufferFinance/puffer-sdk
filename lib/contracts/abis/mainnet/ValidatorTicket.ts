export const ValidatorTicket = <const>[
  {
    type: 'constructor',
    inputs: [
      {
  ...
  {
    type: 'function',
    name: 'setGuardiansFeeRate',
    inputs: [
      {
        name: 'newGuardiansFeeRate',
        type: 'uint256',
        internalType: 'uint256',
      },
    ],
  ...
  {
    type: 'event',
    name: 'GuardiansFeeChanged',
    inputs: [
      {
        name: 'oldGuardiansFee',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
      {
        name: 'newGuardiansFee',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
