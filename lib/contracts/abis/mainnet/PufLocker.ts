export const PufLocker = <const>[
  ...
  { inputs: [], name: 'DepositLocked', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [], name: 'InvalidLockPeriod', type: 'error' },
  { inputs: [], name: 'InvalidRecipientAddress', type: 'error' },
  { inputs: [], name: 'NoWithdrawableAmount', type: 'error' },
  ...
  {
    inputs: [
      { internalType: 'uint128', name: 'minLock', type: 'uint128' },
      { internalType: 'uint128', name: 'maxLock', type: 'uint128' },
    ],
    name: 'setLockPeriods',
    outputs: [],
    stateMutability: 'nonpayable',
